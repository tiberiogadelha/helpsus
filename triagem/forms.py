...
class TriagemForm(forms.Form):
    ...
    pas = forms.IntegerField(label='Pressão sistólica', required=True, min_value=20, max_value=400)
    pad = forms.IntegerField(label='Pressão diástolica', required=True, min_value=20, max_value=400)
